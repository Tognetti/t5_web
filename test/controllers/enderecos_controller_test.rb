...
class EnderecosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create endereco" do
    assert_difference('Endereco.count') do
      post enderecos_url, params: { endereco: { bairro: @endereco.bairro, cidade: @endereco.cidade, cliente_id: @endereco.cliente_id, logradouro: @endereco.logradouro, numero: @endereco.numero } }
    end
  ...
  test "should update endereco" do
    patch endereco_url(@endereco), params: { endereco: { bairro: @endereco.bairro, cidade: @endereco.cidade, cliente_id: @endereco.cliente_id, logradouro: @endereco.logradouro, numero: @endereco.numero } }
